This github contains the code used in a bachelour thesis. All jupyter workshops where used with Google Colab, where the runtime type was set to A100 GPU.
